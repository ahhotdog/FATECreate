...
const I18N = {
    ...
    strings: {
        ...
        // === MENU ===
        menuNew: { en: 'NEW', 'zh-TW': '新建' },
        menuLoad: { en: 'LOAD', 'zh-TW': '讀取' },
        menuInfo: { en: 'INFO', 'zh-TW': '資訊' },
        menuSetting: { en: 'SETTING', 'zh-TW': '設定' },

        // === QUICK SETUP ===
        quickSetupTitle: { en: 'Quick Setup?', 'zh-TW': '快速設定？' },
        quickSetupDesc: { en: 'Would you like to be guided through character creation step-by-step, or skip to the character sheet?', 'zh-TW': '你想要逐步引導建立角色，還是直接跳到角色表？' },
        btnQuickSetup: { en: 'Quick Setup', 'zh-TW': '快速設定' },
        ...
        highConceptLabel: { en: 'High Concept Aspect', 'zh-TW': '高概念面向' },
        highConceptPlaceholder: { en: 'e.g., Wizard Private Eye', 'zh-TW': '例如：巫師私家偵探' },
        highConceptHelp: { en: "This is one of your character's aspects.", 'zh-TW': '這是你角色的面向之一。' },
        ...
        troubleLabel: { en: 'Trouble Aspect', 'zh-TW': '麻煩面向' },
        troublePlaceholder: { en: 'e.g., Sucker for a Pretty Face', 'zh-TW': '例如：見到美女就心軟' },
        troubleHelp: { en: 'This aspect will create interesting complications.', 'zh-TW': '這個面向會製造有趣的麻煩。' },
        ...
        phase1Label: { en: 'Phase One Aspect', 'zh-TW': '階段一面向' },
        phase1Placeholder: { en: 'e.g., I Owe the Mob a Favor', 'zh-TW': '例如：我欠黑幫一個人情' },
        phase1Help: { en: 'This aspect represents a formative experience.', 'zh-TW': '這個面向代表一段成長經歷。' },
        ...
        phase2Label: { en: 'Phase Two Aspect', 'zh-TW': '階段二面向' },
        phase2Placeholder: { en: 'e.g., Saved by My Best Friend', 'zh-TW': '例如：被我最好的朋友救了' },
        phase2Help: { en: 'This aspect represents a connection to others.', 'zh-TW': '這個面向代表與他人的連結。' },
        ...
        phase3Label: { en: 'Phase Three Aspect', 'zh-TW': '階段三面向' },
        phase3Placeholder: { en: 'e.g., Made an Enemy of the Guild', 'zh-TW': '例如：與公會結仇' },
        phase3Help: { en: 'This aspect represents another important connection.', 'zh-TW': '這個面向代表另一段重要的連結。' },
        ...
        coreAspects: { en: 'CORE ASPECTS', 'zh-TW': '核心面向' },
        secondaryAspects: { en: 'SECONDARY ASPECTS', 'zh-TW': '次要面向' },
        ...
        consequencePlaceholder: { en: 'Consequence aspect...', 'zh-TW': '後果面向...' },
    ...
    skills: {
        ...
        'Burglary':     { en: 'Burglary',     'zh-TW': '盜竊' },
        'Contacts':     { en: 'Contacts',     'zh-TW': '人脈' },
        'Crafts':       { en: 'Crafts',       'zh-TW': '工藝' },
        'Deceive':      { en: 'Deceive',      'zh-TW': '欺騙' },
        'Drive':        { en: 'Drive',        'zh-TW': '駕駛' },
        'Empathy':      { en: 'Empathy',      'zh-TW': '同理心' },
        'Fight':        { en: 'Fight',        'zh-TW': '格鬥' },
        'Investigate':  { en: 'Investigate',  'zh-TW': '調查' },
        'Lore':         { en: 'Lore',         'zh-TW': '學識' },
        'Notice':       { en: 'Notice',       'zh-TW': '察覺' },
        'Physique':     { en: 'Physique',     'zh-TW': '體格' },
        'Provoke':      { en: 'Provoke',      'zh-TW': '威嚇' },
        'Rapport':      { en: 'Rapport',      'zh-TW': '交際' },
        'Resources':    { en: 'Resources',    'zh-TW': '資源' },
        'Shoot':        { en: 'Shoot',        'zh-TW': '射擊' },
        'Stealth':      { en: 'Stealth',      'zh-TW': '潛行' },
