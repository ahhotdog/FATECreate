...
const I18N = {
    ...
    strings: {
        ...
        infoVersion: { en: 'Fate Create v1.3 Added NPC generator to the bottom of the character sheet.', 'zh-TW': 'Fate Create v1.3 已在角色卡底部新增 NPC 生成器。', de: 'Fate Create v1.3 NPC-Generator am Ende des Charakterbogens hinzugefügt.', ja: 'Fate Create v1.3 キャラクターシートの最下部にNPCジェネレーターを追加しました。' },
